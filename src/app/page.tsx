  ...
  return (
    <div className="flex h-[100dvh] w-screen bg-black overflow-hidden relative">
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-black relative overflow-hidden h-full">
        ...
        {/* scroll-container and no-overscroll fix for pull-to-refresh hang */}
        <div className="flex-1 overflow-y-auto no-scrollbar pt-20 md:pt-32 pb-40 gradient-bg h-full no-overscroll">
